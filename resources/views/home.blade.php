        ...
        <div class="card text-center">
                ...
                @if (Auth::user()->cliente == 0)
                    ...
                    <div id="card-body" class="card-body">
                        ...
                        <p class="card-text mt-2">Una vez completado el pago el sistema automáticamente empieza a correr con tu cuenta.</p>
                        <div class="d-flex justify-content-center">
                            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                ...
                                <tr><td><input type="hidden" name="on0" value=""></td></tr><tr><td><select name="os0">
                                    <option value="Semanal">Semanal : $9,00 USD - semanal</option>
                    ...
                    <p>Podes cancelar la suscripción cuando quieras desde el sistema.</p>
